    ...
    <div class="p-4">
      ...
      <div class="grid grid-cols-8 gap-4">
        ...
        <div class="col-span-1">
          <div v-for="time in times" :key="time" class="h-16 text-right pr-4">
            {{ time }}
          </div>
        </div>
  
        <!-- Days -->
        <div v-for="day in days" :key="day.date" class="col-span-1">
          <div class="text-center font-medium">{{ day.name }}</div>
